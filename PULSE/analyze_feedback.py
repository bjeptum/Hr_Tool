"""
FeedbackAnalyzer: Smart, clean, and easy-to-use feedback analysis class for sentiment, emotion, topic, and language detection.

Usage:
    from .analyze_feedback import FeedbackAnalyzer
    analyzer = FeedbackAnalyzer()
    result = analyzer.analyze("I'm stressed and my manager ignores me.")
"""
...
class FeedbackAnalyzer:
    """
    Analyze feedback text for sentiment, emotion, topics, and language.
    Provides batch CSV processing and summary utilities.
    """
